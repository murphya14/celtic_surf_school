"""
Django settings for HobbyHunt project.
...
ALLOWED_HOSTS = ['hobbyhunt.herokuapp.com', 'localhost', 'celticsurfschool.herokuapp.com', 'www.celticsurfschool.ie', 'celticsurfschool.ie']
